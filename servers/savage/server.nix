...
with pkgs;
{
  ...
  symlinks = {
    ...
    "mods" = linkFarmFromDrvs "mods" (builtins.attrValues {
      ...
      Servux          = fetchurl { url = "https://cdn.modrinth.com/data/zQhsx8KF/versions/w7Ztj8xb/servux-fabric-26.1-0.10.0.jar";                         sha256 = "sha256-mnciWtnA3uD3es0wtfTG/B4YMyuw/z1KWFucrvBZjx0="; };
