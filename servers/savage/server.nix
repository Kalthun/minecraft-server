...
with pkgs;
{
  ...
  serverProperties = {
    ...
    # Resourcepack
    resource-pack = "https://github.com/Kalthun/minecraft-server/releases/download/ss-rp/ss-rp-1_21_11-v5.zip";
    resource-pack-sha1 = "affaf4ffefc1d6ae8fb1b7f8d8e04cb23884bbcc";
  ...
  symlinks = {
    ...
    "mods" = linkFarmFromDrvs "mods" (builtins.attrValues {
      ...
      EasyShulkerBox  = fetchurl { url = "https://cdn.modrinth.com/data/gA5euN8S/versions/bYZtnl61/EasyShulkerBoxes-v21.11.0-mc1.21.11-Fabric.jar";        sha256 = "sha256-grPKaaUt4eK1Hgu5i/tyLWpNd3XJ3ra8GCWqaRjmTGU="; };
      ...
      ForgeConfAPIP   = fetchurl { url = "https://cdn.modrinth.com/data/ohNO6lps/versions/uXrWPsCu/ForgeConfigAPIPort-v21.11.1-mc1.21.11-Fabric.jar";      sha256 = "sha256-MaBoaQT60c/esdawEawcIoCZDW52rCQWRoFH4iRrTbE="; };
      ...
      Measurements    = fetchurl { url = "https://cdn.modrinth.com/data/wLINU2AB/versions/qBimWTJq/Measurements-fabric-1.21.11-3.7.0.jar";                 sha256 = "sha256-8JfOrvvPj72hDZp+JmJzyRySEt8Rx4Mv+4YwyHA0t3U="; };
